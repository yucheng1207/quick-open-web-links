	...
	public createMainWindow(params: { url?: string, hide?: boolean, openDevTools?: boolean, beforeLoad?: (win: BrowserWindow) => void }): BrowserWindow {
		...
		const options: BrowserWindowConstructorOptions = {
			...
			webPreferences: {
				 ...
				 * 设置为true时渲染进程不能直接通过”const { shell, ipcRenderer } = require('electron')“发送消息了，必须使用preload进行处理，方法看[这里](https://stackoverflow.com/questions/57807459/how-to-use-preload-js-properly-in-electron)
				 */
